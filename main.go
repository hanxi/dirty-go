...
func genDirtyOut(tmpl, out string) {
	...
	outStr := `// Code generated by dirty-go; DO NOT EDIT.
package dirty_out
...
func writeBaseCode(out string) {
	code := `// Code generated by dirty-go; DO NOT EDIT.
package dirty_out
...
func main() {
	...
	for _, name := range fileNames {
		...
		genDirtyOut(infile, outfile)
	}

	outfile := filepath.Join(out, "base.go")
	writeBaseCode(outfile)
}
